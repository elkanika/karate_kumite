...
class CompetitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competitor" do
    assert_difference("Competitor.count") do
      post competitors_url, params: { competitor: { age: @competitor.age, belt: @competitor.belt, dojo: @competitor.dojo, first_name: @competitor.first_name, last_name: @competitor.last_name } }
    end
  ...
  test "should update competitor" do
    patch competitor_url(@competitor), params: { competitor: { age: @competitor.age, belt: @competitor.belt, dojo: @competitor.dojo, first_name: @competitor.first_name, last_name: @competitor.last_name } }
